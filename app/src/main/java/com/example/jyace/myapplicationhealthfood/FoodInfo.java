...
import static com.example.jyace.myapplicationhealthfood.R.layout.exfood;

/**
 * Created by Jyace on 2016/5/11.
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(FoodInfo.this, FoodList.class);
        ...
        SimpleAdapter adapter=new SimpleAdapter(this, data, exfood,new String[]{"TextView04","TextView05"} , new int[]{R.id.TextView04,R.id.TextView05});
